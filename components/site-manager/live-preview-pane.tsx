...
export function LivePreviewPane({
  ...
  return (
    <aside className="portal-preview-pane overflow-hidden rounded-2xl border border-black/10 bg-white shadow-[0_24px_70px_rgba(24,32,29,0.14)] xl:sticky xl:top-24 xl:h-[calc(100vh-7rem)]">
      <header className="flex min-h-16 items-center justify-between gap-4 border-b border-black/10 px-4">
      ...
      <div className="relative h-[42rem] bg-[#ebe7df] xl:h-[calc(100%-4rem)]">
        {previewUrl && !error ? (
          <iframe
            key={previewUrl}
            src={previewUrl}
            title={`${siteName} saved draft preview`}
