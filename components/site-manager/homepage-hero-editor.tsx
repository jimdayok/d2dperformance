...
export function HomepageHeroEditor({ entry, siteSlug, canPublish }: { entry: Entry; siteSlug: string; canPublish: boolean }) {
  ...
  async function openPreview() {
    ...
    const result = await response.json(); if (response.ok) window.open(result.url, "_blank", "noopener,noreferrer"); else setErrorMessage(result.error ?? "Preview could not be opened.");
  }
